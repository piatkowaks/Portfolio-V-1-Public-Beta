    ...
    <section id="code-samples" className="py-20 px-6 relative overflow-hidden scroll-snap-align">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
          ...
          <a href="https://github.com/Draftgamz" target="_blank" rel="noreferrer" className="inline-flex items-center text-github-blue hover:underline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-card p-8 rounded-lg shadow-lg scroll-reveal-right">
            ...
            <div className="space-y-6 text-github-text">
              ...
              <div className="pt-4">
                <a 
                  href="https://github.com/Draftgamz?tab=repositories" 
                  target="_blank"
                  rel="noreferrer"
